	    ...
	    return (
	      React.createElement("div", {className: "modal", onClick: this.fade}, 
	        ...
	        React.createElement("div", {className: "modal-inner"}, 
	          ...
	          React.createElement("div", null, 
	            React.createElement("p", null, React.createElement("input", {type: "text", readOnly: true, onClick: this.select, value: html})), 
	            React.createElement("p", null, React.createElement("input", {type: "text", readOnly: true, onClick: this.select, value: css})), 
	            React.createElement("p", null, React.createElement("input", {type: "text", readOnly: true, onClick: this.select, value: rule}))
	          ), 
